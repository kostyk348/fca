...
fca_video: src/fca_video.cpp src/postfx.cpp include/fca/rules.hpp include/fca/grid.hpp include/fca/denoise.hpp include/fca/temporal.hpp include/fca/postfx.hpp
	$(CXX) $(CXXFLAGS) -o $@ src/fca_video.cpp src/postfx.cpp
