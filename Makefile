...
fca_video: src/fca_video.cpp include/fca/rules.hpp include/fca/grid.hpp include/fca/denoise.hpp include/fca/temporal.hpp
	$(CXX) $(CXXFLAGS) -o $@ src/fca_video.cpp
